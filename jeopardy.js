class Jeopardy {
    constructor(element, options={}) {
       this.useCategoryIds = options.useCategoryIds || [ 1142, 1119, 388, 228]; 
       this.categories = [];
       this.clues = {};
  ...
  * Shuffles array in place. Items An array containing the items.
  @param {Array} a 
  */
 function shuffle(a) {
     let j, x, i;
...
// Credit: https://www.youtube.com/watch?v=fYMBkayHmUo